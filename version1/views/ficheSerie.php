<div class="mangaFiche">
    ...
    {
        ?>
        <div id="<?= $mangaInfo->id ?>" class="mangaLiked <?= ($_SESSION['idManga'] == $mangaInfo->id) && ($_SESSION['mangaLiked'] == 1) ? 'liked' : 'noLiked' ?> cntr"></div>
    <?php }
    ?>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            foreach ($chapterList as $list)
            {
                ?>
                <tr>
                    <td><a id="<?= $list->id ?>" class="chapter"><?= $list->chapter ?></a></td>
